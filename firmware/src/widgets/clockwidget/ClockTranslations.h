...
extern Translation t_clockNixie;
extern Translation t_clockCustom;
extern Translation t_clockNotAvailable;
extern Translation t_clockDefaultType;
...
extern Translation t_clockOverrideNixieColor;
